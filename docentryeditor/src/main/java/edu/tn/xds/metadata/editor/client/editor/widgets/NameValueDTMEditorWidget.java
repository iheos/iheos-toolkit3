...
//		vcontainer.add(nameLabel, new VerticalLayoutData(1, -1));
     ...
     *
     * @param valueTypeEmptyText Default text displayed in an empty value field
     */
...
//		name.setToolTipConfig(nameConfig);
     ...
     *
     * @param valueAllowsBlank true to allow blank to the value field, false otherwise
     */
