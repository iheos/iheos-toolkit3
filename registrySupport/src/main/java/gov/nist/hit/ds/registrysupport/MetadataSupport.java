package gov.nist.hit.ds.registrysupport;
...
public class MetadataSupport {
	...
	static public OMNamespace ebRSns2 =  XmlUtil.om_factory.createOMNamespace(ebRSns2_uri, "rs");

	static public String ebRIMns2_uri = "urn:oasis:names:tc:ebxml-regrep:rim:xsd:2.1";
	static public OMNamespace ebRIMns2 = XmlUtil.om_factory.createOMNamespace(ebRIMns2_uri, "rim");

	static public String ebQns2_uri = "urn:oasis:names:tc:ebxml-regrep:query:xsd:2.1";
	static public OMNamespace ebQns2 =   XmlUtil.om_factory.createOMNamespace(ebQns2_uri, "query");
	...
	static public OMNamespace ebRSns3 =  XmlUtil.om_factory.createOMNamespace(ebRSns3_uri, "rs");

	static public String ebRIMns3_uri = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0";
	static public OMNamespace ebRIMns3 = XmlUtil.om_factory.createOMNamespace(ebRIMns3_uri, "rim");

	static public String ebQns3_uri = "urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0";
	static public OMNamespace ebQns3 =   XmlUtil.om_factory.createOMNamespace(ebQns3_uri, "query");

	static public String ebLcm3_uri = "urn:oasis:names:tc:ebxml-regrep:xsd:lcm:3.0";
	static public OMNamespace ebLcm3 =   XmlUtil.om_factory.createOMNamespace(ebLcm3_uri, "lcm");

	static public String xdsB_uri = "urn:ihe:iti:xds-b:2007";
	static public OMNamespace xdsB =   XmlUtil.om_factory.createOMNamespace(xdsB_uri, "xdsb");
	
	static public OMNamespace xop_include = XmlUtil.om_factory.createOMNamespace("http://www.w3.org/2004/08/xop/include", "xopinclude");
	...
	static public OMNamespace oasis_wsnb2_namespace = XmlUtil.om_factory.createOMNamespace(oasis_wsnb2_namespace_uri, "wsnt");
	...
	public static OMNamespace soapns = XmlUtil.om_factory.createOMNamespace("http://www.w3.org/2003/05/soap-envelope", "soapenv");
	public static OMNamespace wsans = XmlUtil.om_factory.createOMNamespace("http://www.w3.org/2005/08/addressing", "wsa");
	...
	public static OMNamespace epsos_rimext_ns = XmlUtil.om_factory.createOMNamespace(epsos_ns_uri, "rimext");
	...
	public static OMNamespace wsnt_ns =  XmlUtil.om_factory.createOMNamespace(wsnt_ns_uri, "wsnt");
