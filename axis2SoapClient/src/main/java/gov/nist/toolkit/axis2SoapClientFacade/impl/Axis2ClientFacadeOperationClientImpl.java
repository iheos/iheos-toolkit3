package gov.nist.toolkit.axis2SoapClientFacade.impl;

import gov.nist.toolkit.axis2SoapClientFacade.api.Axis2SoapClientFacade;
import gov.nist.toolkit.axis2SoapClientFacade.api.RequestConfig;
import gov.nist.toolkit.axis2SoapClientFacade.validation.RequestParams;
import gov.nist.toolkit.axis2SoapClientFacade.validation.RequestValidator;
...
public class Axis2ClientFacadeOperationClientImpl implements Axis2SoapClientFacade {
	...
	public SOAPEnvelope runBlockingRequest(RequestConfig conf, SOAPEnvelope envelope) throws AxisFault{
