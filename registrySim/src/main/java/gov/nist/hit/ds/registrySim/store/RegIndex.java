...
public class RegIndex implements RegistryValidationInterface, Serializable {
	...
	static public List<StatusValue> docEntryLegalStatusValues = new ArrayList<StatusValue>() {
		private static final long serialVersionUID = 2602830988601842710L;

		{ add(StatusValue.APPROVED); add(StatusValue.DEPRECATED); }
	};
