...
public class MetadataCollection implements Serializable, RegistryValidationInterface {
	...
	public void storeMetadata(OMElement ele,  boolean overwriteOk) throws IOException, MetadataException, ToolkitRuntimeException {
	...
	public void storeMetadata(Metadata m, boolean overwriteOk) throws MetadataException, IOException, ToolkitRuntimeException {
		for (OMElement ele : m.getExtrinsicObjects()) 
	...
	public void storeMetadata(Metadata m) throws MetadataException, IOException, ToolkitRuntimeException {
