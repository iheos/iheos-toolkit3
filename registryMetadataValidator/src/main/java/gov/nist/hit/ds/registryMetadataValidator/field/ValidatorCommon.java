...
public class ValidatorCommon implements IAssertionGroup {
	...
	void add_error(String code, String msg, String location, String resource, String ignore) {
		rel.addError(code, new ErrorContext(msg, resource), location);
	}

	public void err(String msg) {
		add_error(MetadataSupport.XDSRegistryMetadataError, msg, "Attribute.java", null, null);
	}

	public void err(Exception e) {
		add_error(MetadataSupport.XDSRegistryMetadataError, e.getMessage(), "Attribute.java", null, null);
	}

	public void err(String msg, String resource) {
		add_error(MetadataSupport.XDSRegistryMetadataError, msg, null, resource, null);	}
