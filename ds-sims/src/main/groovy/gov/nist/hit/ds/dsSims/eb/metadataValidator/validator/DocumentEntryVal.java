...
public class DocumentEntryVal extends AbstractRegistryObjectVal  implements TopLevelObjectVal {
    ...
    public void validateSlotsCodedCorrectly(ErrorRecorder er, ValidationContext vc)  {
        ...
        validateSlot(model, er, 	"creationTime", 	   false, 	new DtmFormat(er, "Slot creationTime",      table415),  table415);
        validateSlot(model, er, 	"languageCode",		   false, 	new Rfc3066Format(er, "Slot languageCode",      table415),  table415);
        validateSlot(model, er, 	"legalAuthenticator",  false, 	new XcnFormat(er, "Slot legalAuthenticator",table415),  table415);
        validateSlot(model, er, 	"serviceStartTime",	   false, 	new DtmFormat(er, "Slot serviceStartTime",  table415),  table415);
        validateSlot(model, er, 	"serviceStopTime",	   false, 	new DtmFormat(er, "Slot serviceStopTime",   table415),  table415);
        validateSlot(model, er, 	"sourcePatientInfo",   true, 	new SourcePatientInfoFormat(er, "Slot sourcePatientInfo", table415),  table415);
        validateSlot(model, er, 	"sourcePatientId",     false, 	new CxFormat(er, "Slot sourcePatientId",   table415),  table415);
        validateSlot(model, er, 	"hash",			 	   false, 	new HashFormat(er, "Slot hash",   null), 		        table415);
        validateSlot(model, er, 	"size",				   false, 	new IntFormat(er, "Slot size",   table415),             table415);
        validateSlot(model, er, 	"URI",				   true, 	new AnyFormat(er, "Slot URI",   table415),   table415);
        validateSlot(model, er, 	"repositoryUniqueId",	false, 	new OidFormat(er, "Slot repositoryUniqueId",   table415),   table415);
    ...
    public void validateTopAtts(ErrorRecorder er, ValidationContext vc) {
        ...
        validateTopAtts(model, er, vc, table415, DocumentEntryModel.statusValues);
