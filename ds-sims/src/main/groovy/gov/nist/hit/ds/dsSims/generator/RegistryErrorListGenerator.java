...
//			setHomeAsLocation();
	...
	public void add_error(CodeFactory.Code code, String msg, String location, String resource, LogMessage log_message) {
...
//	}
	...
	public void err(CodeFactory.Code code, String msg, String location, String resource,
			Object log_message) {
		add_error(code, msg, location, resource, (LogMessage) log_message);
		
	}

	public void err(CodeFactory.Code code, String msg, String resource) {
		add_error(code, msg, "", resource, null);
		
	}

	public void err(CodeFactory.Code code, Exception e) {
	...
	public void err(CodeFactory.Code code, String msg, Object location, String resource) {
		String loc = "";
		if (location != null)
	...
	public void err(CodeFactory.Code code, String msg, String location, String severity,
			String resource) {
