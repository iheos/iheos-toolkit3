...
public class ClassificationVal extends AbstractRegistryObjectVal {
    ...
    @Override
    public void validateRequiredSlotsPresent(AbstractRegistryObjectModel model, ErrorRecorder er,
                                             ValidationContext vc) {
    }

    @Override
    public void validateSlotsCodedCorrectly(AbstractRegistryObjectModel model, ErrorRecorder er,
                                            ValidationContext vc) {
    }
