...
import gov.nist.hit.ds.dsSims.eb.storedQuery.SQCodeAnd;
import gov.nist.hit.ds.dsSims.eb.storedQuery.SQCodeOr;
import gov.nist.hit.ds.dsSims.eb.storedQuery.SQCodedTerm;
...
//	}
	...
	public List<DocEntry> filterByStatus(List<RegIndex.StatusValue> statuses, List<DocEntry> docs) {
