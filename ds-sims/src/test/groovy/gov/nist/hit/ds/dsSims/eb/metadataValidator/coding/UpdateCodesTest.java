package gov.nist.hit.ds.dsSims.eb.metadataValidator.coding;
...
import gov.nist.hit.ds.dsSims.eb.utility.CodeUpdater;
...
//	@Test 
	public void classificationUuidFindableTest() {
		...
		assertTrue(allCodes.isKnownClassification(new UuidModel(uuid)));
	}
