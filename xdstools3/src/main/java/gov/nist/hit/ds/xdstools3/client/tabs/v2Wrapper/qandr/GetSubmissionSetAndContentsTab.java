 ...
 */
public class GetSubmissionSetAndContentsTab extends V2DynamicTab {

    // tab's title and header
    private static String header = TabLauncher.getSubmissionSetTabLabel;
    ...
    public GetSubmissionSetAndContentsTab(V2TabOpenedEvent event) {
        super(event);
