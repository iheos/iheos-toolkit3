 ...
 */
public class FindDocumentsByRefIdTab extends V2DynamicTab {

    // tab's title and header
    private static String header = TabLauncher.findDocumentsByRefIdTabLabel;
    ...
    public FindDocumentsByRefIdTab(V2TabOpenedEvent event) {
        super(event);
