package gov.nist.hit.ds.xdstools3.client.tabs.MPQTab;
...
import gov.nist.hit.ds.xdstools3.client.customWidgets.healthcareCodes.HealthcareCodeWidget;
...
public class MPQTab extends GenericCloseableToolTab {
    ...
    protected String setTabName() {
        return TabNamesManager.getInstance().getMpqFindDocumentsTabCode();
    }
