 ...
 */
public class MPQFindDocumentsTab extends V2DynamicTab {

    // tab's title and header
    private static String header = TabLauncher.mpqFindDocumentsTabLabel;
    ...
    public MPQFindDocumentsTab(V2TabOpenedEvent event) {
        super(event);
