 ...
 */
public class FindFoldersTab extends V2DynamicTab {

    // tab's title and header
    private static String header = TabLauncher.findFoldersTabLabel;
    ...
    public FindFoldersTab(V2TabOpenedEvent event) {
        super(event);
