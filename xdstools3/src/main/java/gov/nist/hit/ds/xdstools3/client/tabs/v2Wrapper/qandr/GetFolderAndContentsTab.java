 ...
 */
public class GetFolderAndContentsTab extends V2DynamicTab {

    // tab's title and header
    private static String header = TabLauncher.getFolderAndContentsTabLabel;
    ...
    public GetFolderAndContentsTab(V2TabOpenedEvent event) {
        super(event);
