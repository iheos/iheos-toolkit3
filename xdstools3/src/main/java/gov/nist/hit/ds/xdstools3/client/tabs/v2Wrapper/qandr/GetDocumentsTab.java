 ...
 */
public class GetDocumentsTab extends V2DynamicTab {

    // tab's title and header
    private static String header = TabLauncher.getDocumentsTabLabel;
    ...
    public GetDocumentsTab(V2TabOpenedEvent event) {
        super(event);
