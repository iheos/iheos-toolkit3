...
import gov.nist.hit.ds.xdstools3.client.customWidgets.GenericTextItemWithTooltipWidget;
...
public class RetrieveDocumentsTab extends GenericCloseableToolTab {
...
//        repositories.isEndpointValueSelected()
    ...
    protected String setTabName() {
        return TabNamesManager.getInstance().getRetrieveDocumentTabCode();
    }
