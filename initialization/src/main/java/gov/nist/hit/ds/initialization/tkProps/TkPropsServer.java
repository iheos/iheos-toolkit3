package gov.nist.hit.ds.initialization.tkProps;

import gov.nist.hit.ds.initialization.tkProps.client.PropertyNotFoundException;
...
public class TkPropsServer {
	...
	public TkPropsServer(TkProps t) {
		...
		for (gov.nist.hit.ds.initialization.tkProps.client.Prop tp : t.p) {
