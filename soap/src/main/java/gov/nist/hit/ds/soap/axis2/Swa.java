package gov.nist.hit.ds.soap.axis2;
...
public class Swa {
	...
	public OMElement send(OMElement header_contents, OMElement body_contents) throws Exception {
		OMNamespace soap = XmlUtil.om_factory.createOMNamespace("http://schemas.xmlsoap.org/soap/envelope/", "soapenv");
		OMElement envelope = XmlUtil.om_factory.createOMElement("Envelope", soap);
		OMElement header = XmlUtil.om_factory.createOMElement("Header", soap);
		OMElement body = XmlUtil.om_factory.createOMElement("Body", soap);
