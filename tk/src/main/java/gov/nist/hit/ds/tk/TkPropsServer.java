package gov.nist.hit.ds.tk;

import gov.nist.hit.ds.tk.client.PropertyNotFoundException;
import gov.nist.hit.ds.tk.client.TkProps;
...
public class TkPropsServer {
	...
	public TkPropsServer(TkProps t) {
		...
		for (gov.nist.hit.ds.tk.client.Prop tp : t.p) {
