...
public class PatientIdSelector {
	...
	public static PatientIdSelector getInstance(Toolkit2ServiceAsync toolkitService, Panel menuPanel) {
	...
	PatientIdSelector(Toolkit2ServiceAsync toolkitService, Panel menuPanel) {
