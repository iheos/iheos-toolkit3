...
/**
 * Label strings for saving configuration details other than Transactions
 * as properties. Transaction endpoints are defined by the class
 * EndpointLabel.
 * @author bmajur
 *
 */
public class ATConfigLabels {
	...
	public static final String isTls = "UseTLS";
