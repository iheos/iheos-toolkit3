...
import gov.nist.hit.ds.testEngine.logging.ILogger;
...
public class AssertionEngine {
	...
	void buildDataModel() throws XMLParserException, XdsInternalException {
		data = XmlUtil.om_factory.createOMElement(new QName("Data"));
		...
		for (DataRef ref : refs) {
			...
			OMElement wrapper = XmlUtil.om_factory.createOMElement(new QName(ref.as));
