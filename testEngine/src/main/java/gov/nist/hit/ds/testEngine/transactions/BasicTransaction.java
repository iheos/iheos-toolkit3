...
import gov.nist.hit.ds.registryMetadataValidator.field.Validator;
...
import gov.nist.hit.ds.soap.axis2.Soap;
import gov.nist.hit.ds.testEngine.Linkage;
import gov.nist.hit.ds.testEngine.assertion.AssertionEngine;
import gov.nist.hit.ds.testEngine.assertion.ReportManager;
import gov.nist.hit.ds.testEngine.assertion.UseReportManager;
import gov.nist.hit.ds.testEngine.context.PlanContext;
...
import gov.nist.hit.ds.testEngine.logging.OmLogger;
import gov.nist.hit.ds.testEngine.logging.TestLogFactory;
import gov.nist.hit.ds.testEngine.mgmt.TestConfig;
import gov.nist.hit.ds.testEngine.mgmt.TestMgmt;
...
import gov.nist.hit.ds.testengineLogging.NotALogFileException;
import gov.nist.hit.ds.testengineLogging.SectionLogMap;
...
//					endpoint = testConfig.site.getIGRetrieve(home, isSecure, async);
	...
	protected void parseBasicInstruction(OMElement part) throws XdsInternalException {
		...
		if (part_name.equals("Metadata")) { 
			...
			assign_uids = false;
			String id = part.getAttributeValue(XmlUtil.id_qname);
