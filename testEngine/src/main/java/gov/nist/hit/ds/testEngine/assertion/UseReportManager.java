...
import gov.nist.hit.ds.testEngine.RetInfo;
import gov.nist.hit.ds.testEngine.mgmt.TestConfig;
import gov.nist.hit.ds.testEngine.mgmt.TestSection;
import gov.nist.hit.ds.testEngine.mgmt.TestSections;
import gov.nist.hit.ds.testengineLogging.LogFileContent;
import gov.nist.hit.ds.testengineLogging.Report;
...
public class UseReportManager  {
	...
	public OMElement toXML() {
		OMElement urm = XmlUtil.om_factory.createOMElement("UseReports", null);
