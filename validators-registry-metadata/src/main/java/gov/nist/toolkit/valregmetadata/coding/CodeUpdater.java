...
public class CodeUpdater {
    ...
    public void walkTestData(File testDataDir, File codesFile) throws IOException, XdsInternalException, FactoryConfigurationError {
        init(codesFile);
    ...
    public void init(File codesFile) {
        allCodes = new CodesFactory().load(codesFile);
    }

    public List<OMElement> nonConformingCodes(OMElement data) {
    ...
    public void updateClassification(OMElement classification, Code code) {
    ...
    public Code code(OMElement classification) {
