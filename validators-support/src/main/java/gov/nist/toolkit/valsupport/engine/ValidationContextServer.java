 ...
 *
 */
public class ValidationContextServer {
...
//	public boolean minMeta = false;
	...
	public boolean equals(ValidationContextServer v) {
		return
...
//		minMeta == v.minMeta &&
	...
	public void clone(ValidationContextServer v) {
		hasSoap = v.hasSoap;
		hasSaml = v.hasSaml;
		hasHttp = v.hasHttp;
...
//		if (minMeta) buf.append(";MinMetadata");
	...
	public boolean isMessageTypeKnown() {
		...
		|| isXDM || isXcpd || isNwHINxcpd || isC32 || isNcpdp
		;
	}
