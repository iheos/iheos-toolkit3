 ...
 *
 */
public class TestSectionLogContent implements Serializable {
	/**
	 * 
	 */
	...
	public TestSectionLogContent(File logfile) throws FactoryConfigurationError, Exception {
		inputFile = logfile;
		log = Util.parse_xml(logfile);
		init(false);
	}

	public TestSectionLogContent(File logfile, boolean incompleteOk) throws FactoryConfigurationError, Exception {
		inputFile = logfile;
		log = Util.parse_xml(logfile);
		init(incompleteOk);
	}

	public TestSectionLogContent(OMElement testresults) throws NotALogFileException, Exception {
		log = testresults;
		init(false);
	}

	public TestSectionLogContent(OMElement testresults, boolean incompleteOk) throws NotALogFileException, Exception {
		log = testresults;
		init(incompleteOk);
	}
