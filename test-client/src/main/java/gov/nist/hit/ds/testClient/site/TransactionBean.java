...
public class TransactionBean implements  Serializable {
	...
	ATFactory.TransactionType transType = null;
	ATFactory.ActorType actorType = null;
	
	
	// Remove this? Not used for anything real yet.
	public enum RepositoryType  implements  Serializable  { REPOSITORY, ODDS, NONE;
...
//					" RepositoryType=" + repositoryType +
	...
	public TransactionBean(String name, RepositoryType repositoryType, String endpoint, boolean isSecure, boolean
			isAsync) {
	...
	public TransactionBean(ATFactory.TransactionType transType, RepositoryType repositoryType, String endpoint,
	...
	@Deprecated
	public TransactionBean(ATFactory.TransactionType transType, RepositoryType repositoryType, ATFactory.ActorType actorType,
						   String endpoint, boolean isSecure, boolean isAsync) {
		this.transType = transType;
		this.name = transType.getName();
		this.repositoryType = repositoryType;
