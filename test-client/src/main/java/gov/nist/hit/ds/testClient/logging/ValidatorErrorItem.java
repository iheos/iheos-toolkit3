 ...
 *
 */
public class ValidatorErrorItem  {
	public enum ReportingLevel  { SECTIONHEADING, CHALLENGE, EXTERNALCHALLENGE, DETAIL, ERROR, WARNING, D_SUCCESS, D_INFO, D_ERROR, D_WARNING};
	public enum ReportingCompletionType  { ERROR, WARNING, OK };
