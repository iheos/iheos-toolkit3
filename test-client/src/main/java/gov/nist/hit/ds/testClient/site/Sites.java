...
public class Sites {
	...
	public List<Site> getSitesWithActor(ATFactory.ActorType actorType) throws Exception {
	...
	public List<Site> getSitesWithTransaction(ATFactory.TransactionType tt) throws Exception {
		List<Site> rs = new ArrayList<Site>();
	...
	public List<String> getSiteNamesWithActor(ATFactory.ActorType actorType) throws Exception {
	...
	public List<String> getSiteNamesWithTransaction(ATFactory.TransactionType tt) throws Exception {
		List<String> rs = new ArrayList<String>();
