 ...
 * the ErrorRecorder, it is initialized by sim simEngine.
 * @author bmajur
 *
 */
public class SimStep {
	String name = null;
	AssertionGroup assertionGroup = null;  // set by simEngine
	Event event = null;        // set by simEngine
	ValComponent simComponent = null;
    ...
    void setSimComponent(ValComponent component) {
        this.simComponent = component
        crosslink()
    }
	
	ValComponent getSimComponent() { return simComponent }
