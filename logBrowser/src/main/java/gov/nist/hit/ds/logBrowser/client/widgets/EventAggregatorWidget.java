...
public class EventAggregatorWidget extends Composite {
     ...
     */
   public EventAggregatorWidget(SimpleEventBus eventBus, ASSET_CLICK_EVENT assetClickEvent, String externalRepositoryId, String eventAssetId, String assetType, String[] csvColumnNames) throws RepositoryConfigException {
...
//                        logger.info("processing: " + row.getAssetId() + " has object: " + (an!=null));
                        ...
                        htmlRow.add(new EventMessageCell(an,csvFactory.htmlBuilder(linkColValue, true).toSafeHtml(),rowNumber));
...
//                Window.alert(an.getLocation() + ">>" + elem.getTagName()  + " asset: " + an.getAssetId() +  " row num:" + rowNumber);
    ...
    public void setReformattedDisplayColumns(String[] reformattedDisplayColumns) {

        this.reformattedDisplayColumns = new String[FIXED_HEADER_LAST_IDX+displayColumns.length] ;

        this.reformattedDisplayColumns[0] = "Assertion Name";
