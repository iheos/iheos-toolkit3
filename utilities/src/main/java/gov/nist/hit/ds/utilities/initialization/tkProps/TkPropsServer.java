package gov.nist.hit.ds.utilities.initialization.tkProps;

import gov.nist.hit.ds.utilities.initialization.tkProps.client.PropertyNotFoundException;
...
public class TkPropsServer {
	...
	public TkPropsServer(TkProps t) {
		...
		for (gov.nist.hit.ds.utilities.initialization.tkProps.client.Prop tp : t.p) {
