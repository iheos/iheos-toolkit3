 ...
 * </p>
 */
public interface RepositoryManager extends gov.nist.hit.ds.repository.api.OsidManager {
    /**
    ...
    Repository createNamedRepository(String displayName, String description,
        gov.nist.hit.ds.repository.api.Type repositoryType, String repositoryName)
     ...
     *
     * @return gov.nist.hit.ds.repository.api.LongValueIterator
     *
     * @throws gov.nist.hit.ds.repository.api.RepositoryException An exception with one of
     *         the following messages defined in
     *         gov.nist.hit.ds.repository.api.RepositoryException may be thrown: {@link
     ...
     *         gov.nist.hit.ds.repository.api.RepositoryException#UNKNOWN_TYPE
     *         UNKNOWN_TYPE}, {@link
     *         gov.nist.hit.ds.repository.api.RepositoryException#UNKNOWN_REPOSITORY
     *         UNKNOWN_REPOSITORY}
     */
     ...
     *         UNIMPLEMENTED}
     */
    gov.nist.hit.ds.repository.api.TypeIterator getRepositoryTypes()
        throws gov.nist.hit.ds.repository.api.RepositoryException;
