 ...
 * implements gov.nist.hit.ds.repository.api.StringIterator, the class should be in the
 ...
 * </p>
 */
public interface LongValueIterator extends java.io.Serializable {
    /**
     ...
     */
    boolean hasNextLongValue() throws gov.nist.hit.ds.repository.api.RepositoryException;

    /**
     * Return the next long.
     *
     * @return next date as a long value
     *
     * @throws gov.nist.hit.ds.repository.api.SharedException An exception with one of the
     *         following messages defined in gov.nist.hit.ds.repository.api.SharedException
     *         may be thrown:  {@link
     ...
     *         gov.nist.hit.ds.repository.api.SharedException#UNIMPLEMENTED UNIMPLEMENTED},
     *         {@link
     *         gov.nist.hit.ds.repository.api.SharedException#NO_MORE_ITERATOR_ELEMENTS
     *         NO_MORE_ITERATOR_ELEMENTS}
     */
    long nextLongValue() throws gov.nist.hit.ds.repository.api.RepositoryException;
