...
import gov.nist.hit.ds.repository.simple.index.IndexableAsset;
...
public class IndexableRepository extends SimpleRepository {
	...
	/* (non-Javadoc)
	 * @see gov.nist.hit.ds.repository.simple.RepositoryImpl#getAsset(gov.nist.hit.ds.repository.api.Id)
	 */
	@Override
