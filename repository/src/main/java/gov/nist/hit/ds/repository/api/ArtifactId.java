...
/**
 * ArtifactId, originally 'Id', represents a unique identifier. A String representation of the unique
 ...
 * another Id. Id can be auto-generated or user provided. Use {@code isAutoGenerated} to determine the type of Id in use.
 * 
 * <p>
 * OSID Version: 2.0
 * </p>
...
public interface ArtifactId extends java.io.Serializable {
    ...
    /**
     * Indicates whether the representing Id is automatically generated, or a user provided Id.
     * An auto generated Id uses an internal unique key generation method where as the user provided Id is probably more user friendly to recognize.
     *
     * @return boolean
     */
    ...
    /**
     * Sets a user friendly name, it is not a replacement for the unique id.
     * @param name The name
     */
    public void setUserFriendlyName(String name);

    /**
     * Gets the user friendly name, which is only available when the Id is not auto generated.
     * @return
     */
